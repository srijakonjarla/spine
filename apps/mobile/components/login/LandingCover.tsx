...
const SHELF_BOOKS = [
  { title: "on earth...", author: "ocean vuong", bg: "#5d3a42", accent: "#f5ece0" },
  { title: "hungerstone", author: "kat dunn", bg: "#8a5c60", accent: "#d4a843" },
  { title: "the compound", author: "aisling rawle", bg: "#c97b5a", accent: "#faf6f0" },
];
